...
public class AnticovidAgentGameplayA2 : MonoBehaviour

{
    ...
    public void initialise()
    {
        ...
        gridRed = GameObject.Find("redNode");
        gridBlack = GameObject.Find("blackNode");
        player = gameObject.GetComponent<Rigidbody2D>();
        target = GameObject.FindGameObjectWithTag("CovidSpreader").GetComponent<Rigidbody2D>();
